...
//		responseService.setDataValue("sessionId", sessionTool.getSessionId());
//		userFuncService.setLoginInfo(SessionTool.getInstance(request), new LoginInfoModel(2, "test"));
//		responseService.setDataValue("model", userFuncService.getLoginInfo(sessionTool));
